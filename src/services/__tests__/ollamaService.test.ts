...
import { ollamaService, OllamaModel, OllamaRequest, OllamaResponse } from '../ollamaService';
...
describe('OllamaService', () => {
  ...
  describe('isRunning()', () => {
    it('should return true when Ollama is running', async () => {
      ...
      const result = await ollamaService.isRunning();
  ...
  describe('pullModel()', () => {
    it('should pull model with progress tracking', async () => {
      ...
      await ollamaService.pullModel('mistral:7b', (progress) => {
    ...
    it('should handle pull errors gracefully', async () => {
      ...
      await expect(ollamaService.pullModel('invalid:model')).rejects.toThrow(
    ...
    it('should handle empty response body', async () => {
      ...
      await expect(ollamaService.pullModel('mistral:7b')).rejects.toThrow('No response body');
    });
    ...
    it('should handle invalid JSON in stream', async () => {
      ...
      await expect(ollamaService.pullModel('mistral:7b')).resolves.not.toThrow();
    });
  });
  ...
  describe('generate()', () => {
    it('should generate response from model', async () => {
      ...
      const result = await ollamaService.generate(request);
    ...
    it('should use default options when not provided', async () => {
      ...
      await ollamaService.generate(request);
    ...
    it('should handle HTTP errors', async () => {
      ...
      await expect(ollamaService.generate(request)).rejects.toThrow(
        'Failed to generate response from model: nonexistent:model'
      );
    });
  ...
  describe('generateStream()', () => {
    it('should stream response chunks', async () => {
      ...
      await ollamaService.generateStream(request, (chunk) => {
        chunks.push(chunk);
      });
    ...
    it('should handle stream errors', async () => {
      ...
      await expect(
        ollamaService.generateStream(request, () => {})
      ).rejects.toThrow('Failed to generate stream from model: mistral:7b');
    });
  ...
  describe('getModelInfo()', () => {
    it('should return model info when model exists', async () => {
      ...
      const result = await ollamaService.getModelInfo('mistral:7b');
