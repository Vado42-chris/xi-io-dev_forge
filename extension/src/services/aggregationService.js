...
class AggregationService {
     ...
     */
    filterByQuality(responses, threshold = 0.6) {
        // Validate threshold
    ...
    scoreQuality(result) {
        ...
        const score = (factors.length * 0.3 +
            factors.latency * 0.2 +
     ...
     */
    calculateConfidence(responses, consensus) {
        if (responses.length === 0)
            return 0;
        // Confidence based on:
