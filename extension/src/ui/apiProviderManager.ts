...
export class ApiProviderManagerPanel {
  ...
  public static createOrShow(
    ...
    const panel = vscode.window.createWebviewPanel(
      'devForgeApiProviderManager',
      'Dev Forge - API Provider Manager',
    ...
    ApiProviderManagerPanel.currentPanel = new ApiProviderManagerPanel(
      panel,
      extensionUri,
      apiProviderRegistry,
      apiKeyManager
  ...
  private async _addProvider(config: any) {
    try {
  ...
  private async _setApiKey(id: string, apiKey: string) {
    try {
  ...
  private _getHtmlForWebview(webview: vscode.Webview, providers: any[]): string {
